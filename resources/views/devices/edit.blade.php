        ...
        <form action="{{ route('devices.update', $device) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="establishment" name="establishment" value="{{ old('establishment', $device->establishment) }}"
                ...
                <div>
                    ...
                    <input type="text" id="contact_name" name="contact_name" value="{{ old('contact_name', $device->contact_name) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $device->contact_phone) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="address" name="address" value="{{ old('address', $device->address) }}"
                    ...
                    @else
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="any" id="latitude" name="latitude" value="{{ old('latitude', $device->latitude) }}"
                            ...
                            <div>
                                ...
                                <input type="number" step="any" id="longitude" name="longitude" value="{{ old('longitude', $device->longitude) }}"
                                       class="w-full px-3 py-2 rounded-lg border border-border text-sm text-text focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                            </div>
                        </div>
                    @endif

                    <input type="hidden" id="city" name="city" value="{{ old('city', $device->city) }}">
                    <input type="hidden" id="country" name="country" value="{{ old('country', $device->country) }}">
                    @if(config('services.google_maps.key'))
                        <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $device->latitude) }}">
                        <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $device->longitude) }}">
                    @endif
                </div>
